...
<template>
    <div>
        ...
        <Modal :loading="loading" v-model="modal1" title="课时管理" @keydown.enter.native="httpRequest.next()">
        ...
        <Modal :loading="loading" v-model="modal3" title="模型管理" @keydown.enter.native="httpRequest3.next()" width="820">
            ...
            <Input v-model="searchFilter.start_age" placeholder="开始年龄" style="width:250px" v-if="showTransfer"></Input>
            <Input v-model="searchFilter.end_age" placeholder="结束年龄" style="width:250px" v-if="showTransfer"></Input>
